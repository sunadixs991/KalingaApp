...
export default function ManageEvacuationCategory() {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      const docRef = await addDoc(collection(db, "evacuation_categories"), {
        name: newName.trim(),
        icon: newIcon,
        color: newColor,
      });
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      await updateDoc(doc(db, "evacuation_categories", selectedCategory.id), {
        name: newName.trim(),
        icon: newIcon,
        color: newColor,
      });
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              await deleteDoc(doc(db, "evacuation_categories", categoryId));
              setCategories((prev) =>
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.topBarTitle}>Manage Evacuation Category</Text>
      ...
      <Modal visible={adding} transparent animationType="slide">
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            >
              <Text style={styles.modalTitle}>Add New Evacuation Category</Text>
              <TextInput
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <ScrollView
              ...
              keyboardShouldPersistTaps="handled"
            >
              <Text style={styles.modalTitle}>Edit Evacuation Category</Text>
              <TextInput
                placeholder="Category Name"
                value={newName}
                onChangeText={setNewName}
...
const styles = StyleSheet.create({
  ...
  selectedIconOption: { borderColor: "#1976D2", backgroundColor: "#e3f2fd" },
  colorOption: {
    width: 32,
    height: 32,
    borderRadius: 16,
  ...
  selectedColorOption: { borderColor: "#1976D2", borderWidth: 3 },
});